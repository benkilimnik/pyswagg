from pyswagg import App, utils
from .utils import get_test_data_folder
from pyswagg.spec.base import BaseObj
import pyswagg
import unittest
import httpretty
import os
...
class SwaggerCoreTestCase(unittest.TestCase):
    ...
    def test_backward_compatible_v1_2(self):
        ...
        self.assertEqual(pyswagg.SwaggerAuth, pyswagg.Security)
        self.assertEqual(pyswagg.App._create_, pyswagg.App.create)
