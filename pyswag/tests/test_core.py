from pyswag import App, utils
from .utils import get_test_data_folder
from pyswag.spec.base import BaseObj
import pyswag
import unittest
import httpretty
import os
...
class SwaggerCoreTestCase(unittest.TestCase):
    ...
    def test_backward_compatible_v1_2(self):
        ...
        self.assertEqual(pyswag.SwaggerAuth, pyswag.Security)
        self.assertEqual(pyswag.App._create_, pyswag.App.create)
