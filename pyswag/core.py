...
from pyswag import utils, errs, consts
import copy
import base64
import six
import weakref
...
class App(object):
    ...
    def __init__(self, url=None, url_load_hook=None, sep=consts.private.SCOPE_SEPARATOR, prim=None, mime_codec=None, resolver=None):
        ...
        :param prim pyswag.primitives.Primitive: factory for primitives in Swagger.
        :param resolver: pyswag.resolve.Resolver: customized resolver used as default when none is provided when resolving
        """
    ...
    def root(self):
        ...
        :type: pyswag.spec.v2_0.objects.Swagger
        """
        return self.__root
    ...
    def raw(self):
        ...
        :type: ex. when loading Swagger 1.2, the type is pyswag.spec.v1_2.objects.ResourceList
        """
        return self.__raw
    ...
    def op(self):
        ...
        :type: pyswag.utils.ScopeDict of pyswag.spec.v2_0.objects.Operation
        """
        return self.__op
    ...
    def prim_factory(self):
        ...
        :type: pyswag.primitives.Primitive
        """
        return self.__prim
    ...
    def mime_codec(self):
        ...
        :type: pyswag.primitives.MimeCodec
        """
    ...
    def load(kls, url, getter=None, parser=None, url_load_hook=None, sep=consts.private.SCOPE_SEPARATOR, prim=None, mime_codec=None, resolver=None):
        ...
        :type parser: pyswag.base.Context
        ...
        :param mime_codec pyswag.primitives.MimeCodec: MIME codec
        :param resolver: pyswag.resolve.Resolver: customized resolver used as default when none is provided when resolving
...
class BaseClient(object):
    ...
    def prepare_schemes(self, req):
        ...
        :param pyswag.io.Request req: current request object
        """
    ...
    def compose_headers(self, req, headers=None, opt=None, as_dict=False):
        """ a utility to compose headers from pyswag.io.Request and customized headers
